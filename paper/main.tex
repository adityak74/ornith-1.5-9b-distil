...
\title{\HALT{}: Quantization Breaks Stopping Before It Breaks Reasoning\\
\large Diagnosing and Repairing Termination Failure in a 4-bit Reasoning Model with a Harness-Applied Limit on Thinking}
