\begin{table}[t]
\centering
\caption{The soft ramp across the quantization ladder and the 35B teacher, HumanEval, 2{,}048-token budget, our harness, $n_0 = 1{,}024$, $s = 0.02$. The gain tracks the truncation count on every build, full precision included; \emph{Regr.} is items correct under plain decoding that the ramp gets wrong.}
